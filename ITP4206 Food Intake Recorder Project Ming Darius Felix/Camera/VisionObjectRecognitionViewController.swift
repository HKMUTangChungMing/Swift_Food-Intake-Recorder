...
class VisionObjectRecognitionViewController: gViewController {
    ...
    func setupVision() -> NSError? {
        ...
        guard let modelURL = Bundle.main.url(forResource: "HealthfoodDetector", withExtension: "mlmodelc") else {
